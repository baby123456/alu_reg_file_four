...
add_file ${dcpDir}/${inst_pm2}_${pm2_v1}_route_design.dcp 
set_property SCOPED_TO_CELLS { inst_alu_user2 } [get_files ${dcpDir}/${inst_pm2}_${pm2_v1}_route_design.dcp]
...
#todo
set_property SCOPED_TO_CELLS { inst_alu_user3 } [get_files $synthDir/${pm}/${pm_v1}/${pm_v1}_synth.dcp]
